...
```bash
sudo ln -s /etc/freeradius/sites-available/eduroam /etc/freeradius/3.0/sites-enabled/eduroam 
sudo ln -s /etc/freeradius/sites-available/eduroam-inner-tunnel  /etc/freeradius/3.0/sites-enabled/eduroam-inner-tunnel
```
